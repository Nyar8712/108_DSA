...
同時，司助教原本也都會很快改出作業成績，並且提供補交和寄信詢問，越到學期後越反覆無常，老師明言成績繳交前都可以補交等，助教最後幾乎不給補交，最後兩次作業將近3-4周才提供成績，並且原本一直堅持告知的分數計算方式提供也都直接不管了，一個字也沒有，連讓我們寫信詢問和上訴的機會也不給，種種操作和手法真的讓人滿臉問號。
